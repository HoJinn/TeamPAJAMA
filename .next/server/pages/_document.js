...
class MyDocument extends next_document__WEBPACK_IMPORTED_MODULE_1___default.a {
  render() {
    ...
    return __jsx(next_document__WEBPACK_IMPORTED_MODULE_1__["Html"], {
      ...
      async: true,
      defer: true,
      src: `https://maps.googleapis.com/maps/api/js?key=${googleMapKey}&language=ko`
...
MyDocument.getInitialProps = async ctx => {
  ...
  const sheets = new _material_ui_core__WEBPACK_IMPORTED_MODULE_2__["ServerStyleSheets"]();
