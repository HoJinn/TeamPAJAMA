...
var axios = __webpack_require__("9TJK");

// CONCATENATED MODULE: ./src/entity/CertificationToken.ts
function _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }

class CertificationToken {
  constructor(certificationType, access_token, refreshToken, createdDate, expireDate, token_type, scope) {
    _defineProperty(this, "certificationType", void 0);

    _defineProperty(this, "access_token", void 0);

    _defineProperty(this, "refreshToken", void 0);

    _defineProperty(this, "createdDate", void 0);

    _defineProperty(this, "createNumber", void 0);

    _defineProperty(this, "expireDate", void 0);

    _defineProperty(this, "expireNumber", void 0);

    _defineProperty(this, "token_type", void 0);
...
// CONCATENATED MODULE: ./pages/api/[social].ts
...
/* harmony default export */ var _social_ = __webpack_exports__["default"] = ((req, res) => {
  if (!req.query.social) {
    res.status(400).json({
      code: -100,
...
const kakaoTokenProcess = (req, res) => {
  const clientReqBody = Object(util["a" /* pick */])(req.query, ['code']);
  ...
  Object(axios["a" /* NextAxios */])().post(reqUrl, Object(util["c" /* toQuery */])(params), {
    headers
  }).then(axiosRes => {
    const {
      data
    } = Object(axios["c" /* defSuccess */])(axiosRes);
    const cur = new Date();
...
const googleTokenProcess = (req, res) => {
  const clientReqBody = Object(util["a" /* pick */])(req.query, ['code', 'scope', 'authuser', 'prompt', 'social']);
  ...
  Object(axios["a" /* NextAxios */])().post(reqUrl, params).then(axiosRes => {
    const {
      data
    } = Object(axios["c" /* defSuccess */])(axiosRes);
    const cur = new Date();
...
const naverTokenProcess = (req, res) => {
  const clientReqBody = Object(util["a" /* pick */])(req.query, ['code', 'state']);
  ...
  Object(axios["a" /* NextAxios */])().get(reqUrl, {
    params
  }).then(axiosRes => {
    const {
      data
...
module.exports = __webpack_require__("/THU");
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return NextAxios; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return defSuccess; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return defError; });
...
axios__WEBPACK_IMPORTED_MODULE_0___default.a.defaults.headers.post['Content-Type'] = ContentType.JSON;
axios__WEBPACK_IMPORTED_MODULE_0___default.a.defaults.headers.put['Content-Type'] = ContentType.JSON;
axios__WEBPACK_IMPORTED_MODULE_0___default.a.defaults.headers.patch['Content-Type'] = ContentType.JSON;
axios__WEBPACK_IMPORTED_MODULE_0___default.a.defaults.headers.delete['Content-Type'] = ContentType.JSON;
axios__WEBPACK_IMPORTED_MODULE_0___default.a.defaults.timeout = 5000; // Axios.defaults.baseURL = process.env.NEXT_PUBLIC_API_URL;
...
const NextAxios = ctx => {
  if (ctx && ctx.req) {
    ...
    if (cookie) axios__WEBPACK_IMPORTED_MODULE_0___default.a.defaults.headers.Cookie = cookie; // Object
    //   .keys(clientHeaders)
    //   .forEach( key => Axios.defaults.headers.common[key] = clientHeaders[key] )
  }

  return _objectSpread(_objectSpread({}, axios__WEBPACK_IMPORTED_MODULE_0___default.a), {}, {
    get: (url, config) => axios__WEBPACK_IMPORTED_MODULE_0___default.a.get(url, _objectSpread({
      timeout: GET_TIMEOUT
    }, config)),
    multipart: (url, data, config) => {
      const headers = (config === null || config === void 0 ? void 0 : config.headers) || {};
      return axios__WEBPACK_IMPORTED_MODULE_0___default.a.post(url, data, _objectSpread(_objectSpread({}, config), {}, {
...
/* unused harmony default export */ var _unused_webpack_default_export = (axios__WEBPACK_IMPORTED_MODULE_0___default.a);
