...
module.exports = __webpack_require__("69hS");
...
/* harmony import */ var src_axios__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("9TJK");
/* harmony import */ var src_util__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("GN+H");
...
const naverUnlink = (req, res) => {
  const naverToken = Object(src_util__WEBPACK_IMPORTED_MODULE_1__[/* pick */ "a"])(req.body, ['access_token']);
  ...
  Object(src_axios__WEBPACK_IMPORTED_MODULE_0__[/* NextAxios */ "a"])().get(reqUrl, {
    params
  }).then(naverRes => {
    const {
      data
    ...
    const {
      data
    } = Object(src_axios__WEBPACK_IMPORTED_MODULE_0__[/* defError */ "b"])(naverErr);
    res.status(400).json({
      code: -100,
      entity: data
    });
...
const kakaoUnlink = (req, res) => {
  const kakaoToken = Object(src_util__WEBPACK_IMPORTED_MODULE_1__[/* pick */ "a"])(req.body, ['access_token']);
  ...
  Object(src_axios__WEBPACK_IMPORTED_MODULE_0__[/* NextAxios */ "a"])().post(`${reqHost}/v1/user/unlink`, undefined, {
    headers
  }).then(kakaoRes => {
    const {
      data
    ...
    const {
      data
    } = Object(src_axios__WEBPACK_IMPORTED_MODULE_0__[/* defError */ "b"])(kakaoErr);
    res.status(400).json({
      code: -100,
      entity: data
    });
